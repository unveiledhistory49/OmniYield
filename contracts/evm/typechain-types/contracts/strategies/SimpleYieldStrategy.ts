...
export interface SimpleYieldStrategyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_asset"
      | "asset"
...
export interface SimpleYieldStrategy extends BaseContract {
  connect(runner?: ContractRunner | null): SimpleYieldStrategy;
  waitForDeployment(): Promise<this>;

  interface: SimpleYieldStrategyInterface;
